...
export function Rec({ historyId }) {
  ...
  return (
    <div id="parentDiv" style={{
      ...
      <div id="parentDiv" style={{
        width: "90%", height: "700px", backgroundColor: 'white', margin: "0 auto", textAlign: "center", borderRadius: "10px", padding: "30px", marginTop: "20px", boxShadow: "5px 5px 10px"
      }
      } >
        <p class="font-extrabold text-rec text-xl"><em>
        </em> </p>
        {transcription ? <div id="childDiv" className="flex flex-col w-full transition-colors py-3 px-3 items-center gap-3 relative rounded-md  break-all pr-[4.5rem] )} )} hover:bg-gray-400 border group animate-flash overflow-y-scroll" style={{ backgroundColor: "white", fontFamily: "Noto Sans KR", fontWeight: "700", padding: "30px", fontSize: "18px", color: "#2D353F", lineHeight: "50px", textAlign: "left" }}>
          ...
          />) :
            <div className="text-justify">{transcription}</div>}</div> : <Spinner />}
      </ div>
