...
export function Rec( { historyId } ) {
  ...
  const handleSave = () => {
    ...
    axios.post( "http://localhost:8000/history/change_transcription", body ).then( ( res ) => {
  ...
  return (
    <div id="parentDiv" style={ {
      ...
      <div id="parentDiv" style={ {
        ...
        { transcription ? <div id="childDiv" className="flex flex-col w-full transition-colors py-3 px-3 items-center gap-3 relative rounded-md  break-all pr-[4.5rem] )} )} hover:bg-gray-400 border group animate-flash">
