...
function MainContent({ selectedId }) {
  ...
  return (
    <div className="container overflow-y-scroll" >
      ...
      <Link className="hover:bg-gray-100" to="/main/record" style={{ width: "95%", height: "70px", borderRadius: "5px", paddingTop: "25px", textAlign: "center" }}>
        <p class="font-extrabold text-lg" style={{ fontSize: "20px" }}><em>속기본</em></p></Link>
      <Link className="hover:bg-gray-100" to="/main/summary" style={{ width: "95%", height: "70px", borderRadius: "5px", paddingTop: "25px", textAlign: "center" }}>
        <p class="font-extrabold text-lg" style={{ fontSize: "20px" }}><em>요약본</em></p></Link>
      <Link className="hover:bg-gray-100" to="/main/question" style={{ width: "95%", height: "70px", borderRadius: "5px", paddingTop: "25px", textAlign: "center" }}>
        <p class="font-extrabold text-lg" style={{ fontSize: "20px" }}><em>문제</em></p></Link>
