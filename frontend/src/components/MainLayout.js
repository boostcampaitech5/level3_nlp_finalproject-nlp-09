                      ...
                      <div className="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                        ...
                        <ul className="flex flex-col gap-3.5 w-full sm:max-w-md m-auto">
                          <li className="w-full text-lg bg-gray-50 dark:bg-white/5 p-7 rounded-md border">
                            <div style={{ fontFamily: "Inter", fontWeight: "800", fontSize: "21px", marginBottom: "15px", color: "#56657A" }}>
                              Insert a link or Attach audio files
                            </div>
                            <div style={{ fontFamily: "Inter", fontWeight: "500", fontSize: "17px", color: "#5F7087" }}>
