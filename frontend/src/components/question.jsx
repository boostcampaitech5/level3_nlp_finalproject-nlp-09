...
export function Ques( { historyId } ) {
  ...
  return (
    <div id="parentDiv" style={ { backgroundColor: '#39A387', color: "black", width: "100%", height: "100%", position: "relative", paddingTop: "40px", borderRadius: "15px", boxShadow: "10px 10px 5px gray" } }>
              ...
              <div key={ qna.qna_id }>
                { editingItemId === qna.qna_id ?
                  (
                    ...
                    <ol key={ qna.qna_id } className="flex flex-col w-full transition-colors py-3 px-3 items-center gap-3 relative rounded-md cursor-pointer break-all pr-[4.5rem] )} )} hover:bg-gray-200 border group animate-flash" key={ qna.qna_id }>
