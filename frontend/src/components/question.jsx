...
export function Ques({ historyId }) {
  ...
  const handleSave = (qnaId, index) => {
    ...
    axios.post(`http://${process.env.REACT_APP_BACKEND_SERVER_ADDRESS}/history/change_qna`, body).then((res) => {
  ...
  const onClickDel = (qnaId) => {
    ...
    axios.post(`http://${process.env.REACT_APP_BACKEND_SERVER_ADDRESS}/history/delete_qna`, body).then((res) => {
      console.log(res.data);
      const result = res.data
      if (result.type) {
  ...
  const fetchData = () => {
    ...
    setQNAList(null);
    axios.post(`http://${process.env.REACT_APP_BACKEND_SERVER_ADDRESS}/history/qna`, body).then((res) => {
      console.log(res.data);
      const result = res.data
