            ...
            <div className="c4209fc2d ce0449bc6">
              <div className="cf12edc27">
                ...
                <div className="ca920f895 ca8471e59">
                  ...
                  <div className="c47c8448a c0ae8e25b">
                    <span>Or</span>
                  </div>
                  <div className="c10017d5e cc4f8cbc7">

                    <form
                      method="post"
                      data-provider="google"
                      className="c23436cee c3a9dc8ac ca5a8d128"
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="cb748e84b c06a93f6e c32451f76"
                        data-provider="google"
                        data-action-button-secondary="true"
                      >
                        <span
                          className="c200921a3 c6af18580"
                          data-provider="google"
                        />
                        <span className="cf5a17d0a">Continue with Google</span>
                      </button>
                    </form>
