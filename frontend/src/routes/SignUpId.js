...
function SignUpId() {
  ...
  const onSubmit = (event) => {
    ...
    axios.post(`http://${process.env.REACT_APP_BACKEND_SERVER_ADDRESS}/signup/id_validation`, body).then((res) => {
  ...
  return (
    ...
    specifically here */ .js-required {"{"} display: none !important; {"}"}
      ...
      <div>
        <header className="oai-header" style={{ marginBottom: "60px" }}>
          ...
          <section className="ca775d19e _prompt-box-outer c20fc64c7">
            <div className="c4209fc2d ce0449bc6">
              <div className="cf12edc27">
                <h1 className="ce6e62a0a c7f8e3f9b" style={{ fontFamily: "Inter", fontWeight: "700", fontSize: "30px", marginBottom: "30px" }}>Create your account</h1>
                  ...
                  <div className="ce1af4c6a ca1203c69">
                    <div className="cedacd3f9">
                      <form
                        onSubmit={onSubmit}
                        // method="POST"
                        className="c210378a2 _form-signup-id"
                        data-form-primary="true"
                      >
                        <input
                          type="hidden"
                          name="state"
                          defaultValue="hKFo2SBfbFdZQVVJSHdLTmVmalRuRzFQNDZMMVUzam9DNUt2ZqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIHlwTjB3LWJhU1lxWDNZZHRGaWRkVmR4SjJOYWV1a0dvo2NpZNkgVGRKSWNiZTE2V29USHROOTVueXl3aDVFNHlPbzZJdEc"
                        />
                        <div className="ce1af4c6a ca1203c69">
                          <div className="cedacd3f9">
                            <div className="input-wrapper _input-wrapper">
                              ...
                              >
                                ...
                                <input
                                  className="input ca4b7f6ee c853886b0 hover:gray-800"
                                  inputMode="email"
                                  name="email"
                                  id="email"
                                  type="text"
                        ...
                        <div className="cf772ffae">
                          <button
                            ...
                            name="action"
                            value="default"
                            className="c89f1057d c08709d93 cfdf7e7ce c948a708e _button-signup-id"
